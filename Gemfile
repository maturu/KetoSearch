...
# Custom
# Use Slim for compact HTML
gem 'slim-rails', '3.1.3'
# Use FontAwesome for stylesheets of SCSS
gem 'font-awesome-sass', '~> 5.4.1'
# Use Chartkick for creating beautiful JS charts
gem 'chartkick'
# Use Gon for getting Rails variables in JS
gem 'gon'
